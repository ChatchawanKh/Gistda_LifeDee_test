...
const MapDng = () => {
  ...
  const [selectedYear45, setselectedYear45] = useState(2024);
  ...
  const rcp45Select = () => {
    ...
    map.goTo({
      center: { lon: 102.711189, lat: 15.044594 },
      zoom: 6,
    });
    ...
    //////// RCP45 TIME + 4 1)2029 2)2033 3)2037 4)2042 5)2046 ////////
     ...
     const newWmsLayer = new window.sphere.Layer("0", {
        ...
        url: `https://gistdaportal.gistda.or.th/arcgis/services/GISTDA_LifeD/Dengue_cases_monthly/MapServer/WMSServer/&time=${selectedYear45}-01-01`,
        // time: '2023-12-31',
        zoomRange: { min: 1, max: 15 },
        zIndex: 5,
        opacity: 1,
        format: "image/png",
        id: "Dengue_cases_and_cases_per_100k_monthly",
      });
    ...
    // if (match) {
    //   const startBuddhist = `01/01/${selectedYear45 + 543}`;
    //   const endBuddhist = `01/02/${(selectedYear45 + 1) + 543}`;
    //   setbudhistYear(`${startBuddhist} - ${endBuddhist}`);
    //   console.log(setbudhistYear);
    ...
    setrcpLayer("ไข้เลือดออก");

    const rcp45Data = async () => {
      try {
        const res = await axios.get(
          `https://gistdaportal.gistda.or.th/imagedata/rest/services/GISTDA_LifeD/dengue/ImageServer/identify`,
          {
            params: {
