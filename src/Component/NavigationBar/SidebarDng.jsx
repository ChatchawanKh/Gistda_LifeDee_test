...
export default function MiniDrawer({ openSidebar, toggleSidebar }) {
    ...
    const [activeItem, setActiveItem] = React.useState('โรคไข้เลือดออก');
        ...
        <Box ref={drawerRef} sx={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
            ...
            <Drawer variant="permanent" open={openSidebar} sx={{
                ...
                <DrawerHeader>
                    ...
                    <IconButton onClick={toggleSidebar} sx={{ color: '#D16D6A', width: '40px', height: '40px' }}>
                        ...
                        <ListItem key={text} disablePadding sx={{ display: 'block', mb: 0.5 }}>
                            ...
                            >
                                <ListItemButton
                                    onClick={() => {
                                        setActiveItem(text);
                                        navigate(path); // เปลี่ยนเส้นทางเมื่อคลิก
                                    }}
                                    sx={{
                                        minHeight: 48,
                                        borderRadius: '10px',
                                        ...
                                        px: 2.5,
                                        backgroundColor: activeItem === text ? '#D16D6A' : 'transparent',
                                        '&:hover': {
                                ...
                                >
                                    <ListItemIcon
                                        sx={{
                                            ...
                                            color: activeItem === text ? '#ffffff' : '#D16D6A',
                                    ...
                                    <ListItemText
                                        ...
                                        sx={{
                                            ...
                                            color: activeItem === text ? '#fff' : '#D16D6A',
                                        }}
                                    />
                                </ListItemButton>
                            </Tooltip>
                ...
                <List sx={{ top: '0.25rem' }}>
                    {[
                        ...
                        { text: 'คู่มือการใช้งาน', icon: <PictureAsPdfRoundedIcon />, path: '/manual' },
                        { text: 'วีดีโอสาธิตการใช้งาน', icon: <SmartDisplayRoundedIcon />, path: '/video' },
                    ].map(({ text, icon, path }) => (
