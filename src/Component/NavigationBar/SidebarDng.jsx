      ...
      >
        <DrawerHeader>
          ...
          <IconButton
            ...
            sx={{ color: "#d16d6a", width: "40px", height: "40px" }}
          >
                ...
                >
                  <ListItemButton
                    sx={{
                      ...
                      px: 2.5,
                      backgroundColor:
                        activeItem === text ? "#d16d6a" : "transparent",
                      "&:hover": {
              ...
              >
                <ListItemButton
                  sx={{
                    ...
                    px: 2.5,
                    backgroundColor:
                      activeItem === "งานวิจัย" ? "#d16d6a" : "transparent",
                    "&:hover": {
                      backgroundColor: "#d16d6a",
                      borderRadius: "10px",
                      "& .MuiListItemIcon-root": {
                ...
                >
                  <ListItemIcon
                    sx={{
                      ...
                      mr: openSidebar ? 3 : "auto",
                      justifyContent: "center",
                      color: activeItem === "งานวิจัย" ? "#ffffff" : "#d16d6a",
                      transform:
                  ...
                  <ListItemText
                    ...
                    sx={{
                      opacity: openSidebar ? 1 : 0,
                      transition: "font-size 0.3s ease-in-out",
                      color: activeItem === "งานวิจัย" ? "#fff" : "#d16d6a",
                    }}
                  />
                  {openSidebar &&
                    (openResearch ? (
