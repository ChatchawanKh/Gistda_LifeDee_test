...
export default function MiniDrawer({ openSidebar, toggleSidebar }) {
    ...
    const [activeItem, setActiveItem] = React.useState('โรคฮีทสโตรก');
        ...
        <Box ref={drawerRef} sx={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
            ...
            <Drawer variant="permanent" open={openSidebar} sx={{
                ...
                <DrawerHeader>
                    ...
                    <IconButton onClick={toggleSidebar} sx={{ color: '#FFA447', width: '40px', height: '40px' }}>
                ...
                <List>
                    {[
                        ...
                        <ListItem key={text} disablePadding sx={{ display: 'block', mb: 0.5 }}>
                            ...
                            >
                                <ListItemButton
                                    onClick={() => handleNavigate(path, text)}
                                    sx={{
                                        minHeight: 48,
                                        borderRadius: '10px',
                                        marginLeft: '5px',
