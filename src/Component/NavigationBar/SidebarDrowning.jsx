...
export default function MiniDrawer({ openSidebar, toggleSidebar }) {
  ...
  const [activeItem, setActiveItem] = React.useState("Drowning");
      ...
      >
        <DrawerHeader>
          ...
          <IconButton
            ...
            sx={{ color: "#344ca3", width: "40px", height: "40px" }}
          >
                ...
                >
                  <ListItemButton
                    sx={{
                      ...
                      px: 2.5,
                      backgroundColor:
                        activeItem === text ? "#344ca3" : "transparent",
                      "&:hover": {
                  ...
                  >
                    <ListItemIcon
                      sx={{
                        ...
                        color: activeItem === text ? "#ffffff" : "#344ca3",
                    ...
                    <ListItemText
                      ...
                      sx={{
                        ...
                        color: activeItem === text ? "#fff" : "#344ca3",
                      }}
                    />
                  </ListItemButton>
                </Tooltip>
              ...
              >
                <ListItemButton
                  sx={{
                    ...
                    px: 2.5,
                    backgroundColor:
                      activeItem === "งานวิจัย" ? "#344ca3" : "transparent",
                    "&:hover": {
                      backgroundColor: "#344ca3",
                      borderRadius: "10px",
                      "& .MuiListItemIcon-root": {
                ...
                >
                  <ListItemIcon
                    sx={{
                      ...
                      mr: openSidebar ? 3 : "auto",
                      justifyContent: "center",
                      color: activeItem === "งานวิจัย" ? "#ffffff" : "#344ca3",
                      transform:
                  ...
                  <ListItemText
                    ...
                    sx={{
                      opacity: openSidebar ? 1 : 0,
                      transition: "font-size 0.3s ease-in-out",
                      color: activeItem === "งานวิจัย" ? "#fff" : "#344ca3",
                    }}
                  />
                  {openSidebar &&
                    (openResearch ? (
                  ...
                  >
                    <ListItemButton
                        ...
                        sx={{
                          ...
                          justifyContent: openSidebar ? "initial" : "center",
                          px: 2.5,
                          backgroundColor: activeItem === text ? "#344ca3" : "transparent",
                          "&:hover": {
                            backgroundColor: "#344ca3",
                            borderRadius: "10px",
                            "& .MuiListItemText-primary": {
