      ...
      >
        <DrawerHeader>
          ...
          <IconButton
            ...
            sx={{ color: "#8DBAFF", width: "40px", height: "40px" }}
          >
          ...
          <List>
            {[
              ...
              <ListItem
                key={text}
                disablePadding
                sx={{ display: "block", mb: 0.5, fontFamily: "Prompt"}}
              >
                <Tooltip
                ...
                >
                  <ListItemButton
                    sx={{
                      ...
                      px: 2.5,
                      backgroundColor:
                        activeItem === text ? "#8DBAFF" : "transparent",
                      "&:hover": {
              ...
              >
                <ListItemButton
                  sx={{
                    ...
                    px: 2.5,
                    backgroundColor:
                      activeItem === "งานวิจัย" ? "#8DBAFF" : "transparent",
                    "&:hover": {
                      backgroundColor: "#8DBAFF",
                      borderRadius: "10px",
                      "& .MuiListItemIcon-root": {
                ...
                >
                  <ListItemIcon
                    sx={{
                      ...
                      mr: openSidebar ? 3 : "auto",
                      justifyContent: "center",
                      color: activeItem === "งานวิจัย" ? "#ffffff" : "#8DBAFF",
                      transform:
                  ...
                  <ListItemText
                    ...
                    sx={{
                      opacity: openSidebar ? 1 : 0,
                      transition: "font-size 0.3s ease-in-out",
                      color: activeItem === "งานวิจัย" ? "#fff" : "#8DBAFF",
                      fontFamily: "Prompt"
                    }}
                  />
                  {openSidebar &&
                    (openResearch ? (
                      <ExpandLess
                        sx={{
                          ...
                          ".MuiListItemButton:hover &": { color: "#ffffff" },
                        }}
                      />
                    ) : (
                      <ExpandMore
