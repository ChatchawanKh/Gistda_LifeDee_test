...
import ModalPM25 from "/assets/Icon/pm25_level_modal.svg";
...
export default function Dashboard({ openDashboard, toggleDashboard }) {
  ...
  const getPm25Level = (pmvalue) => {
    if (pmvalue < 15)
      return "คุณภาพอากาศดีมากเหมาะสำหรับกิจกรรมกลางแจ้ง และการท่องเที่ยว";
    if (pmvalue <= 25)
      return "คุณภาพอากาศดีเหมาะสำหรับกิจกรรมกลางแจ้ง และการท่องเที่ยว";
    if (pmvalue <= 37.5)
      return "คุณภาพอากาศปานกลาง ลดระยะเวลาการทำกิจกรรมหรือการออกกำลังกายกลางแจ้งที่ใช้แรงมาก ";
    if (pmvalue <= 75)
      return "คุณภาพอากาศเริ่มมีผลต่อสุขภาพ ควรใช้อุปกรณ์ป้องกันตนเอง เช่น หน้ากากป้องกัน PM2.5 ทุกครั้งที่ออกนอกอาคาร";
    if (pmvalue > 75)
      return "คุณภาพอากาศมีผลต่อสุขภาพ ประชาชนทุกคนควรงดกิจกรรมกลางแจ้ง";
  ...
  const bg_pm25avg_color =
    pm25avgFormatted !== null ? getPm25Color(pm25Avg24hr) : null;
  const bg_pm25perhr_color =
    pm25perhrFormatted !== null ? getPm25Color(pm25perhrFormatted) : null;

  //level description and color//
  const level_pm25avg =
    pm25avgFormatted !== null ? getPm25Level(pm25avgFormatted) : null;
  const level_pm25avg_color =
    pm25avgFormatted !== null ? getLevelPm25AvgColor(pm25avgFormatted) : null;
  const level_pm25perhr_color =
    pm25perhrFormatted !== null
      ? getLevelPm25AvgColor(pm25perhrFormatted)
      : null;
  ...
  const pm10Search = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:5000/getAQI");
  ...
  const variants = {
    ...
    visible: {
      x: 0,
      transition: { type: "tween", duration: 1.0, ease: [0.25, 0.1, 0.25, 1] },
    },
  };
          ...
          >
            ...
            <div className="card-swipe-detail">
              ...
              >
                <SwiperSlide>
                  <div
                    className="pm25-1day-card"
                    style={{ backgroundColor: bg_pm25avg_color }}
                  >
                ...
                <SwiperSlide>
                  <div
                    className="pm25-1hr-card"
                    style={{ backgroundColor: bg_pm25perhr_color }}
                  >
                ...
                <SwiperSlide>
                  <div
                    className="pm10-1hr-card"
                    style={{ backgroundColor: bg_pm10_color }}
                  >
                ...
                <SwiperSlide>
                  <div
                    className="aqi-card"
                    style={{ backgroundColor: bg_aqi_color }}
                  >
              ...
              <>
                <HighchartsReact
                  ...
                  options={{
                    chart: {
                      ...
                      events: {
                        load: function () {
                          ...
                          const maxIndex =
                            xAxis.max || graphData.categories.length - 1; // ดัชนีสุดท้ายของข้อมูล
                    ...
                    title: {
                      text: `ข้อมูล PM2.5 ย้อนหลัง ณ ${
                        tb_name_th ? `${tb_name_th} ` : ""
                      }${ap_name_th ? `${ap_name_th} ` : ""}${
